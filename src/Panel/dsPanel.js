...
function newRequest(request) {
    ...
    var queryParams = {};
    if ((reqType === 'classic') || (reqType === 'universal') || (reqType === 'dc_js') || (reqType === 'sitecatalyst') || (reqType === 'tr') || (reqType === 'wbtrkk') || (reqType === 'youbora') || (reqType === 'comscore') || (reqType === 'ga-audiences')  || (reqType === 'criteo')) {
        try {
